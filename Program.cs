...
namespace WebApp2
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                client.BaseAddress = new Uri(apiString); // Óêàæèòå áàçîâûé àäðåñ âàøåãî API
            });
            builder.Services.AddHttpClient<BrosShopImagesController>();

            // Ðåãèñòðàöèÿ ApplicationContext ñ çàâèñèìîñòÿìè
            ...
            {
                options.IdleTimeout = TimeSpan.FromMinutes(30); // Óñòàíîâèòå âðåìÿ îæèäàíèÿ
                options.Cookie.HttpOnly = true; // Çàùèòèòå êóêè
                options.Cookie.IsEssential = true; // Ñäåëàéòå êóêè îáÿçàòåëüíûìè
            });
